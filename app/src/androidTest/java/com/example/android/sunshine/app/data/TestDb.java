...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long weatherId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,null,cv);
        assertFalse("id should be != from -1", weatherId == -1);
        ...
        // query if you like)
        TestUtilities.validateCursor("Cursor is not Equal to Content Values",c,cv);
    ...
    public long insertLocation() {
        ...
        assertFalse("id should be != from -1", id == -1);
        // Query the database and receive a Cursor back
